...
const ProctorStudents = () => {
  ...
  const updateSelection = async (sid) => {
    await fetch(`http://20.0.2.0:4500/student?sid=${sid}`)
      .then((res) => res.json())
      .then((data) => {
        // console.log(data)
    ...
    if (selection[0] && selection[0]["profile"])
      await fetch(
        `http://20.0.2.0:4500/student/marks?usn=${selection[0].profile.usn}`
      )
        .then((res) => res.json())
        .then((data) => {
          // console.log(data)
    ...
    if (selection[0] && selection[0]["profile"])
      await fetch(
        `http://20.0.2.0:4500/student/details?usn=${selection[0].profile.usn}`
      )
        .then((res) => res.json())
        .then((data) => {
          // console.log(data)
  ...
  useEffect(() => {
    fetch(`http://20.0.2.0:4500/proctor/students?pid=${userInfo.googleId}`)
      .then((res) => res.json())
      .then((data) => {
        console.log(data);
        processStudents(data);
